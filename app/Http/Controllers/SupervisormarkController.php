...
class SupervisormarkController extends Controller
{
    /**
...
if(request()->ajax())
     {
      ...
      return DataTables::of($data)
        ...
        $user= User:: all();
        return view('admin.supervisormark',compact('user'));
    }
    ...
    public function store(Request $request)
    {
        $rules = array(
            ...
            's_name' => 'required',
            'semester' => 'required',
            'email' => 'required|email|string|max:255|unique:supervisor__marks',        
            'spr_mark' => 'required'
       ...
       $student = new Supervisor_Mark;
         ...
         $student->spr_initial  = $request->input('spr_initial');
         $student->spr_name  = $request->input('spr_name');
