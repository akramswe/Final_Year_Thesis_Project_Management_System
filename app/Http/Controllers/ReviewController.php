...
if(request()->ajax())
     {
      ...
      return DataTables::of($data)
                    ->addColumn('action', function($data){
                        $button = '<button type="button" name="edit" id="'.$data->id.'" class="edit btn btn-primary btn-sm"> <i class="fa fa-pencil-square-o"></i> Feedback</button>';
                        return $button;
                    })
                    ->rawColumns(['action'])
                    ->make(true);
        ...
        $user= User:: all();
        return view('admin.review',compact('user'));
    }
