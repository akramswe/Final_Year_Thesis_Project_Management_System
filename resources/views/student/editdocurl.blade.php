...
<marquee><h3><b>Dear student, Upload Your Embed Video URL here.</b></h3></marquee>
 ...
 <form class="well form-horizontal"  action="{{action('DocurlController@update', $id)}}" method = "post" enctype="multipart/form-data">
                              {{csrf_field()}}
<input type = "hidden" name = "_token" value = "<?php echo csrf_token(); ?>">
         <input type="hidden" name="_method" value="PATCH" />
<fieldset>
<h2 align="center">EDIT DOC URL FORM</h2>
...
<div class="form-group">
  ...
  <textarea name="url" placeholder="description" class="form-control"  type="password">{{ $student->f_url}} </textarea>
    </div>
  </div>
</div>
