      ...
      <div class="modal-header">
          ...
          <div class="modal-body">
            ...
            <form method="post" id="sample_form" class="form-horizontal">
              ...
              <div class="form-group">
               ...
               <div class="form-group">
                ...
                <div class="col-md-8">
                  <input type="text" name="spr_initial" readonly id="sv_init" class="form-control" />
                </div>
              </div>
             <input type="hidden" name="spr_name" id="sv_name" class="form-control" />
            ...
            <div class="form-group">
                ...
                <div class="col-md-8">
                  <input type="text" name="spr_mark"  id="spr_mark" class="form-control" />
                </div>
              </div>
...
fetch_data();
 ...
 function fetch_data(category = '')
 {
  ...
  $('#sample_form').on('submit', function(event){
    ...
    if($('#action').val() == 'Add')
    {
      action_url = "{{ route('supervisor.store') }}";
    }
    ...
    {
      action_url = "{{ route('supervisor.update') }}";
    }
  ...
  $(document).on('click', '.update', function(){
    ...
    $('#form_result').html('');
    $.ajax({
      url :"http://swe.application.daffodilvarsity.edu.bd/final_project/public/supervisor/"+id+"/edit",
      dataType:"json",
      success:function(data)
      {
