...
$(document).ready(function(){
 ...
 function fetch_data(category = '')
 {
  ...
  $('#user_table').DataTable({
    ...
    //     if (data === "MIDVIDEO") {
    //         return '<i class="far fa-dot-circle" style="color:red" /*aria-hidden="true"*/>0</i>';
    //     }
    //     if (!data) {
    //         return '<i class="far fa-dot-circle" style="color:orange" /*aria-hidden="true"*/>1</i>';
    //     }
    ...
    if (!data) {
            return '<i class="far fa-dot-circle" style="color:red" /*aria-hidden="true"*/>Submission Not Done</i>';
        }
        else
        {
          return "<iframe src=\"" + data + "\" height=\"150\" alt='No Image'/>";}  
        }
