          ...
          <div class="modal-body">
            ...
            <form method="post" id="sample_form" class="form-horizontal">
              ...
              <div class="form-group">
                ...
                <div class="col-md-8">
                  <input type="text" name="name" id="name" placeholder="Enter Here Student Name" class="form-control"  readonly />
                </div>
              </div>
              <div class="form-group">
                <label class="control-label col-md-4">Email : </label>
                <div class="col-md-8">
                  <input id="email_id" type="email" class="form-control @error('email_id') is-invalid @enderror" name="email_id" value="{{ old('email') }}" required autocomplete="email" placeholder="example@diu.edu.bd" pattern=".+@diu.edu.bd" title="Please enter your DIU e-mail address" readonly>
              ...
              <div class="form-group">
                ...
                <div class="col-md-8">
                  <input id="std_id" type="text" class="form-control @error('email_id') is-invalid @enderror" name="std_id" value="{{ old('email') }}" placeholder="Your Student ID" readonly>
...
$(document).ready(function(){
  ...
  $(document).on('click', '.edit', function(){
    ...
    $('#form_result').html('');
    $.ajax({
      url :"http://swe.application.daffodilvarsity.edu.bd/final_project/public/updatepass/"+id+"/edit",
      dataType:"json",
      success:function(data)
      {
  ...
  $('#ok_button').click(function(){
    $.ajax({
      url:"http://swe.application.daffodilvarsity.edu.bd/final_project/public/updatepass/destroy/"+user_id,
      beforeSend:function(){
