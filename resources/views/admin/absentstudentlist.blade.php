            ...
            <form method="post" id="sample_form" class="form-horizontal">
              ...
              <div class="form-group">
               ...
               <div class="form-group">
                ...
                <div class="col-md-8">
                  <input type="text" name="sv_init" readonly id="sv_init" class="form-control" />
                </div>
              </div>
              <div class="form-group">
            <label class="control-label col-md-4" for="exampleFormControlSelect1">Semester</label>
            <div class="col-md-8">
...
fetch_data();
 ...
 function fetch_data(category = '')
 {
  ...
  $('#sample_form').on('submit', function(event){
    ...
    if($('#action').val() == 'Add')
    {
      action_url = "{{ route('shiftsemester.store') }}";
    }

    if($('#action').val() == 'Edit')
    {
      action_url = "{{ route('shiftsemester.update') }}";
    }
  ...
  $(document).on('click', '.edit', function(){
    ...
    $('#form_result').html('');
    $.ajax({
      url :"http://swe.application.daffodilvarsity.edu.bd/final_project/public/shiftsemester/"+id+"/edit",
      dataType:"json",
      success:function(data)
      {
        ...
        $('#hidden_id').val(id);
        $('.modal-title').text('Shift Next Semester');
        $('#action_button').val('Shift');
        $('#action').val('Edit');
        $('#formModal').modal('show');
      }
    })
  ...
  $('#ok_button').click(function(){
    $.ajax({
      url:"http://swe.application.daffodilvarsity.edu.bd/final_project/public/shiftsemester/destroy/"+user_id,
      beforeSend:function(){
